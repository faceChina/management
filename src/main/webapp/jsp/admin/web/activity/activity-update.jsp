...
<html lang="zh-cn">
							...
							<div class="content">
								<form action="${ctx }/web/activity/insert.htm" id="jform" class="form-horizontal" method="post">
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input class="form-control" type="text"  value="${slcoinActivity.name }" id="name" name="name" placeholder="${slcoinActivity.name }" maxlength="64">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="text" id="beginTime" class="form-control dateFirst" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'});" readonly="readonly" name="beginTime" placeholder="<fmt:formatDate value="${slcoinActivity.beginTime }" pattern="yyyy-MM-dd HH:mm:ss"/>">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="text" id="endTime" class="form-control dateFirst" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'});" readonly="readonly" name="endTime" placeholder="<fmt:formatDate value="${slcoinActivity.endTime }" pattern="yyyy-MM-dd HH:mm:ss"/>">
										</div>
									</div>
									<hr>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input class="form-control" type="text" value="${slcoinActivity.inviteAmount }" id="inviteAmount" name="inviteAmount" placeholder="${slcoinActivity.inviteAmount }" maxlength="3">
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input class="form-control" type="text" value="${slcoinActivity.registerAmount }" id="registerAmount" name="registerAmount" placeholder="${slcoinActivity.registerAmount }"  maxlength="3">
										</div>
										<label class="col-sm-4"><span>个</span></label>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input class="form-control" type="text" value="${slcoinActivity.superAmount }" id="superAmount" name="superAmount" placeholder="${slcoinActivity.superAmount }"  maxlength="3">
										</div>
										<label class="col-sm-4"><span>个</span></label>
									</div>
	...
	<script type="text/javascript">
		...
		function save(){
			...
			if(superAmount==''){
				superAmount = $('#superAmount').attr("placeholder");
			}
			...
			var param = {id:${slcoinActivity.id},'name':name,'beginTimeVo':beginTime,'endTimeVo':endTime,'inviteAmount':inviteAmount,'registerAmount':registerAmount,'superAmount':superAmount};
