...
<html>
	<head>
		...
		<script type="text/javascript" src="${jspPath}web/activity/CenterGridInvitationUser.js" charset="UTF-8"></script>
		
		<script type="text/javascript">
			//刷新活动列表
			function reloadGrid(){
				var gridPanel = Ext.getCmp('grid-invitationUser-view');
			...
			Ext.onReady(function() {
				Ext.QuickTips.init();
				var centerGridInvitationUser = new CenterGridInvitationUser({id:'f_panel_invitationUser_view'});
				new Ext.Viewport( {
					layout : 'fit',
					border : false,
					items : [centerGridInvitationUser]
				});
