/**
 * 页面右边属性列表
 * @class CenterGridInvitationUser
 * @extends Ext.Panel
 */

CenterGridInvitationUser = Ext.extend(Ext.Panel,{
	//刷脸用户查询地址
	queryInvitationUserGridUrl:ROOT_PATH+"/web/activity/invitationUserList.htm",
	gridPanel:null,
	constructor:function(cfg){
		Ext.applyIf(this,cfg);
		this.initUIComponents(this);
		CenterGridInvitationUser.superclass.constructor.call(this, {
	...
	initToolBar:function(selfCmp){
		...
		{// 顶部工具栏 '-'为竖线分隔符
			...
			handler : function() {// 所调用的函数
				var grid = Ext.getCmp("grid-invitationUser-view")
				var toolbarIdArray = ['invitationUserToolBar'];
	...
	initUIComponents:function(selfCmp){
        ...
        selfCmp.gridPanel=new Com.panel.EvecomBaseGridPanel({
        	queryUrl:this.queryInvitationUserGridUrl,//jsp传来
        	selType:1,
        	isAutoQuery:false,
        	singleSelect:false,
        	pkField:"id",
...
Ext.reg('CenterGridInvitationUser', CenterGridInvitationUser);