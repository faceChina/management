/**
 * 编辑部门用户窗口
 * @class EditFormPanelOrganUser
 * @extends Ext.Panel
 * formPanel 编辑部门用户信息表单
 */
EditFormPanelOrganUser = Ext.extend(Ext.Panel,{
	/**
	 * 重写构造函数，cfg为自定义参数
	 * @param {} cfg
	 */
	constructor : function(cfg){
		...
		EditFormPanelOrganUser.superclass.constructor.call(this, {
			modal : true,
			layout:'fit',
	...
	initUIComponents:function(selfCmp){
		...
		selfCmp.formPanel = new Ext.form.FormPanel({
			...
			frame:true,
			labelAlign:"right",
			url:modifySysUserUrl,
 		items:[
			{xtype:'hidden',name:'sysUser.suId',id:'suId'},
			{xtype:'hidden',name:'sysUser.suPwd',id:'suPwd'},
	...
	loadForm:function(userId){
		this.formPanel.getForm().load({
				...
				url : querySysUserObjectUrl+userId,
				waitMsg : "用户信息加载中...",
				success : function(form,action) {
				},
				failure : function(form,action) {
