            ...
            new Ext.Viewport({
                ...
                },*/
                {
                    ...
                    items: [{
                        ...
                        listeners: {
                            'eventclick': {
                                fn: function(vw, rec, el){//rec是指Ext.calendar.EventMappings
                                	var alendarDate = rec.data.StartDate.format("Y-m-d");
                                	jspEditdutyUserWindow(alendarDate);
                                },
                                scope: this
                            },
                            ...
                            'dayclick': {
                                fn: function(vw, dt, ad, el){
                                	var alendarDate = dt.format("Y-m-d");
                                	jspEditdutyUserWindow(alendarDate);
                                },
                                scope: this
                            },
